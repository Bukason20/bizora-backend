...
export interface ApiFeedbackFeedback extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    experienceFeedback: Schema.Attribute.Text;
    improvementSuggestions: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    editToken: Schema.Attribute.UID & Schema.Attribute.Required;
    email: Schema.Attribute.Email;
    ...
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'businessName'> & Schema.Attribute.Required;
    template: Schema.Attribute.Relation<'manyToOne', 'api::template.template'>;
    trialEndsAt: Schema.Attribute.DateTime;
    trialStartsAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
